...
def test_main_summary_template():
    """
    Final test to verify our fixes work with the main summary.html template.
    """
    print("Testing with main summary.html template...")
    ...
    with app.app_context():
        try:
            ...
            print("\nRendering template...")
            html = render_template('templates/summary.html', **context)
            ...
            with open('main_summary_test_output.html', 'w') as f:
                f.write(html)
            print("Full HTML saved to main_summary_test_output.html for inspection")
...
if __name__ == "__main__":
    success = test_main_summary_template()
    
    if success:
        print("\nFixes have been successfully applied to the main summary.html template!")
        print("Custom optional items should now display properly in all formats.")
    else:
        print("\nFurther investigation required to fix the main summary.html template.")